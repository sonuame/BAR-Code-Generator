...
namespace BarCodeGenerator.Symbologies
{
    class Code93 : BarcodeCommon, IBarcode
    {
        ...
        private void init_Code93()
        {
            ...
            C93_Code.Rows.Add(new object[] { "43", "(", "100100110" });      
            C93_Code.Rows.Add(new object[] { "44", ")", "111011010" });      
            C93_Code.Rows.Add(new object[] { "45", "#", "111010110" });      
            C93_Code.Rows.Add(new object[] { "46", "@", "100110010" });      
